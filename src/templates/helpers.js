...
*This document was generated by [ShipLegal](https://ship-legal.vercel.app) and is provided for informational purposes only. It does not constitute legal advice. We recommend consulting with a qualified attorney for your specific needs.*`;

export const LEGAL_DISCLAIMER_PRO = `---

*This document is provided for informational purposes only. It does not constitute legal advice. We recommend consulting with a qualified attorney for your specific needs.*`;

export function getDisclaimer(isPro) {
  return isPro ? LEGAL_DISCLAIMER_PRO : LEGAL_DISCLAIMER;
}
